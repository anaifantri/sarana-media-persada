    ...
    <div
        ...
        @if (session()->has('loginError'))
            <div class="flex items-center justify-center m-auto">
                <div class="flex items-center justify-center alert-danger">
                    <svg class="w-6 fill-red-800 mx-1" clip-rule="evenodd" fill-rule="evenodd"
                    ...
                    <span class="font-semibold mx-1 text-red-800">Warning!!</span>
                    <span class="mx-1 text-red-800">{{ session('loginError') }}</span>
                </div>
            </div>
        @endif
